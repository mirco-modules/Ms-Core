 ...
 * @since 12/7/2024 4:54 PM
 */
@Component
public class QueryServiceHelper<ENTITY> {
     ...
     * @return a Specification
     */
    public  <X extends Comparable<? super X>> Specification<ENTITY> buildRangeSpecification(RangeFilter<X> filter,
     ...
     * @return a Specification
     */
    public  <X extends Comparable<? super X>> Specification<ENTITY> buildSpecification(RangeFilter<X> filter,
     ...
     * @return a Specification
     */
    public  <OTHER, X> Specification<ENTITY> buildReferringEntitySpecification(Filter<X> filter,
     ...
     * @return a Specification
     */
    public  <OTHER, MISC, X> Specification<ENTITY> buildReferringEntitySpecification(Filter<X> filter,
     ...
     * @return a Specification
     */
    public  <OTHER, X extends Comparable<? super X>> Specification<ENTITY> buildReferringEntitySpecification(
     ...
     * @return a Specification
     */
    public  <OTHER, MISC, X extends Comparable<? super X>> Specification<ENTITY> buildReferringEntitySpecification(
            RangeFilter<X> filter,
            Function<Root<ENTITY>, SetJoin<MISC, OTHER>> functionToEntity,
            Function<SetJoin<MISC, OTHER>, Expression<X>> entityToColumn) {
     ...
     * @return a Specification.
     */
    public  <X> Specification<ENTITY> equalsSpecification(Function<Root<ENTITY>, Expression<X>> metaclassFunction, X value) {
     ...
     * @return a Specification.
     */
    public  <X> Specification<ENTITY> notEqualsSpecification(Function<Root<ENTITY>, Expression<X>> metaclassFunction, X value) {
     ...
     * @return a {@link org.springframework.data.jpa.domain.Specification} object.
     */
    public Specification<ENTITY> doesNotContainSpecification(Function<Root<ENTITY>, Expression<String>> metaclassFunction,
                                                                String value) {
     ...
     * @return a {@link org.springframework.data.jpa.domain.Specification} object.
     */
    public  <X> Specification<ENTITY> byFieldSpecified(Function<Root<ENTITY>, Expression<X>> metaclassFunction,
                                                         boolean specified) {
        return specified ?
     ...
     * @return a {@link org.springframework.data.jpa.domain.Specification} object.
     */
    public  <X> Specification<ENTITY> byFieldEmptiness(Function<Root<ENTITY>, Expression<Set<X>>> metaclassFunction,
                                                         boolean specified) {
        return specified ?
     ...
     * @return a {@link org.springframework.data.jpa.domain.Specification} object.
     */
    public  <X> Specification<ENTITY> valueIn(Function<Root<ENTITY>, Expression<X>> metaclassFunction,
                                                Collection<X> values) {
     ...
     * @return a {@link org.springframework.data.jpa.domain.Specification} object.
     */
    public  <X> Specification<ENTITY> valueNotIn(Function<Root<ENTITY>, Expression<X>> metaclassFunction,
                                                   Collection<X> values) {
        return (root, query, builder) -> {
            CriteriaBuilder.In<X> in = builder.in(metaclassFunction.apply(root));
            for (X value : values) {
     ...
     * @return a {@link org.springframework.data.jpa.domain.Specification} object.
     */
    public  <X extends Comparable<? super X>> Specification<ENTITY> greaterThanOrEqualTo(Function<Root<ENTITY>, Expression<X>> metaclassFunction,
                                                                                           X value) {
     ...
     * @return a {@link org.springframework.data.jpa.domain.Specification} object.
     */
    public  <X extends Comparable<? super X>> Specification<ENTITY> greaterThan(Function<Root<ENTITY>, Expression<X>> metaclassFunction,
                                                                                  X value) {
     ...
     * @return a {@link org.springframework.data.jpa.domain.Specification} object.
     */
    public  <X extends Comparable<? super X>> Specification<ENTITY> lessThanOrEqualTo(Function<Root<ENTITY>, Expression<X>> metaclassFunction,
                                                                                        X value) {
     ...
     * @return a {@link org.springframework.data.jpa.domain.Specification} object.
     */
    public  <X extends Comparable<? super X>> Specification<ENTITY> lessThan(Function<Root<ENTITY>, Expression<X>> metaclassFunction,
                                                                               X value) {
     ...
     * @return a {@link org.springframework.data.jpa.domain.Specification} object.
     */
    public Specification<ENTITY> distinct(boolean distinct) {
