 ...
 */
@ControllerAdvice
public class ModulesExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    @Value("${jhipster.clientApp.name:project}")
    private String applicationName;

    private final Environment env;

    public ModulesExceptionTranslator(Environment env) {
        this.env = env;
    }
    ...
    protected ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
    ...
    protected String extractTitle(Throwable err, int statusCode) {
        return getCustomizedTitle(err) != null ? getCustomizedTitle(err) : extractTitleForResponseStatus(err, statusCode);
    }

    protected List<FieldErrorVM> getFieldErrors(MethodArgumentNotValidException ex) {
        return ex
            .getBindingResult()
            .getFieldErrors()
            .stream()
    ...
    protected String extractTitleForResponseStatus(Throwable err, int statusCode) {
    ...
    protected String extractURI(NativeWebRequest request) {
        HttpServletRequest nativeRequest = request.getNativeRequest(HttpServletRequest.class);
        return nativeRequest != null ? nativeRequest.getRequestURI() : StringUtils.EMPTY;
    }

    protected HttpStatus toStatus(final Throwable throwable) {
    ...
    protected ResponseStatus extractResponseStatus(final Throwable throwable) {
        return Optional.ofNullable(resolveResponseStatus(throwable)).orElse(null);
    }

    protected ResponseStatus resolveResponseStatus(final Throwable type) {
    ...
    protected String getCustomizedTitle(Throwable err) {
        if (err instanceof MethodArgumentNotValidException) return "Method argument not valid";
        return null;
    }

    protected String getCustomizedErrorDetails(Throwable err) {
    ...
    protected HttpStatus getMappedStatus(Throwable err) {
    ...
    protected HttpHeaders buildHeaders(Throwable err) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "org.khasanof.core.widgets");
    }
}
